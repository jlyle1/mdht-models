...
"value.code = '67843-3' and value.codeSystem = '2.16.840.1.113883.6.1'";
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EMS_SOCIAL_HISTORY_SECTION_DRUG_USE_INDICATION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.nullFlavor <> vocab::NullFlavor::NI implies entry->exists(entry : cda::Entry | not entry.observation.oclIsUndefined() and entry.observation.oclIsKindOf(emspcr::DrugUseIndication) and entry.typeCode = vocab::x_ActRelationshipEntry::DRIV)";
	...
	/**
	 * The cached OCL expression body for the '{@link #getDrugUseIndications(EMSSocialHistorySection) <em>Get Drug Use Indications</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDrugUseIndications(EMSSocialHistorySection)
	 * @generated
	 * @ordered
	 */
	protected static final String GET_DRUG_USE_INDICATIONS__EOCL_EXP = "self.getObservations()->select(observation : cda::Observation | not observation.oclIsUndefined() and observation.oclIsKindOf(emspcr::DrugUseIndication)).oclAsType(emspcr::DrugUseIndication)";

	/**
	 * The cached OCL query for the '{@link #getDrugUseIndications(EMSSocialHistorySection) <em>Get Drug Use Indications</em>}' query operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDrugUseIndications(EMSSocialHistorySection)
	 * @generated
	 * @ordered
	 */
	protected static OCLExpression<EClassifier> GET_DRUG_USE_INDICATIONS__EOCL_QRY;
	...
	public static  EList<DrugUseIndication> getDrugUseIndications(EMSSocialHistorySection emsSocialHistorySection) {
		...
		OCL.Query query = EOCL_ENV.createQuery(GET_DRUG_USE_INDICATIONS__EOCL_QRY);
		@SuppressWarnings("unchecked")
		Collection<DrugUseIndication> result = (Collection<DrugUseIndication>) query.evaluate(emsSocialHistorySection);
		return new BasicEList.UnmodifiableEList<DrugUseIndication>(result.size(), result.toArray());
	}
