...
public class HeadAssessmentOperations extends ClinicalStatementOperations {
	...
	public static  boolean validateHeadAssessmentTemplateId(HeadAssessment headAssessment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_HEAD_ASSESSMENT_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(headAssessment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HeadAssessmentHeadAssessmentTemplateId"),
						 new Object [] { headAssessment }));
			}
	...
	public static  boolean validateHeadAssessmentMoodCode(HeadAssessment headAssessment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_HEAD_ASSESSMENT_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(headAssessment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HeadAssessmentHeadAssessmentMoodCode"),
						 new Object [] { headAssessment }));
			}
	...
	public static  boolean validateHeadAssessmentCodeP(HeadAssessment headAssessment, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HeadAssessmentHeadAssessmentCodeP"),
						 new Object [] { headAssessment }));
			}
...
"value.code = '67525-6' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateHeadAssessmentCode(HeadAssessment headAssessment, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.emspcr.HeadAssessmentCodeP");
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HeadAssessmentHeadAssessmentCode"),
						 new Object [] { headAssessment }));
			}
	...
	public static  boolean validateHeadAssessmentEffectiveTime(HeadAssessment headAssessment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_HEAD_ASSESSMENT_EFFECTIVE_TIME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(headAssessment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HeadAssessmentHeadAssessmentEffectiveTime"),
						 new Object [] { headAssessment }));
			}
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17208-2' or value.code = 'LA17209-0' or value.code = 'LA17210-8' or value.code = 'LA17211-6' or value.code = 'LA17213-2' or value.code = 'LA17214-0' or value.code = 'LA17212-4' or value.code = 'LA18220-6' or value.code = 'LA18221-4' or value.code = 'LA18222-2' or value.code = 'LA18223-0' or value.code = 'LA18224-8' or value.code = 'LA18225-5' or value.code = 'LA18226-3' or value.code = 'LA6626-1' or value.code = 'LA6630-3' or value.code = 'LA7410-9' or value.code = 'LA7452-1' or value.code = 'LA7460-4' or value.code = 'LOINC_TBDA_549' or value.code = 'LOINC_TBDA_550' or value.code = 'LOINC_TBDA_551' or value.code = 'LOINC_TBDA_552')))";
	...
	public static  boolean validateHeadAssessmentValue(HeadAssessment headAssessment, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HeadAssessmentHeadAssessmentValue"),
						 new Object [] { headAssessment }));
			}
