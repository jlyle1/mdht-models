 ...
 *   <li>{@link org.openhealthtools.mdht.uml.cda.emspcr.ExtremitiesAssessment#validateExtremitiesAssessmentValueP(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Extremities Assessment Value P</em>}</li>
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ExtremitiesAssessmentExtremitiesAssessmentTemplateId"),
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ExtremitiesAssessmentExtremitiesAssessmentMoodCode"),
						 new Object [] { extremitiesAssessment }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ExtremitiesAssessmentExtremitiesAssessmentCodeP"),
						 new Object [] { extremitiesAssessment }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ExtremitiesAssessmentExtremitiesAssessmentCode"),
						 new Object [] { extremitiesAssessment }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ExtremitiesAssessmentExtremitiesAssessmentEffectiveTime"),
						 new Object [] { extremitiesAssessment }));
			}
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17208-2' or value.code = 'LA17209-0' or value.code = 'LA17214-0' or value.code = 'LA17215-7' or value.code = 'LA17220-7' or value.code = 'LA17229-8' or value.code = 'LA17244-7' or value.code = 'LA17245-4' or value.code = 'LA17260-3' or value.code = 'LA17261-1' or value.code = 'LA17262-9' or value.code = 'LA17263-7' or value.code = 'LA17264-5' or value.code = 'LA17265-2' or value.code = 'LA17266-0' or value.code = 'LA17267-8' or value.code = 'LA17268-6' or value.code = 'LA17269-4' or value.code = 'LA17270-2' or value.code = 'LA17271-0' or value.code = 'LA17272-8' or value.code = 'LA17273-6' or value.code = 'LA17274-4' or value.code = 'LA17344-5' or value.code = 'LA17709-9' or value.code = 'LA18220-6' or value.code = 'LA18222-2' or value.code = 'LA18223-0' or value.code = 'LA18224-8' or value.code = 'LA18225-5' or value.code = 'LA18226-3' or value.code = 'LA18249-5' or value.code = 'LA6626-1' or value.code = 'LA6630-3' or value.code = 'LA7410-9' or value.code = 'LA7452-1' or value.code = 'LA7460-4' or value.code = 'LOINC_TBDA_927')))";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ExtremitiesAssessmentExtremitiesAssessmentValue"),
						 new Object [] { extremitiesAssessment }));
			}
	...
	/**
	 * The cached OCL expression body for the '{@link #validateExtremitiesAssessmentValueP(ExtremitiesAssessment, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Extremities Assessment Value P</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateExtremitiesAssessmentValueP(ExtremitiesAssessment, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 * @ordered
	 */
	protected static final String VALIDATE_EXTREMITIES_ASSESSMENT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (self.value->forAll(element | element.oclIsTypeOf(datatypes::CD)))";

	/**
	 * The cached OCL invariant for the '{@link #validateExtremitiesAssessmentValueP(ExtremitiesAssessment, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Extremities Assessment Value P</em>}' invariant operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #validateExtremitiesAssessmentValueP(ExtremitiesAssessment, org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	...
	protected static Constraint VALIDATE_EXTREMITIES_ASSESSMENT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateExtremitiesAssessmentValueP(ExtremitiesAssessment extremitiesAssessment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_EXTREMITIES_ASSESSMENT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.EXTREMITIES_ASSESSMENT);
			try {
				VALIDATE_EXTREMITIES_ASSESSMENT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_EXTREMITIES_ASSESSMENT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_EXTREMITIES_ASSESSMENT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(extremitiesAssessment)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 EmspcrValidator.DIAGNOSTIC_SOURCE,
						 EmspcrValidator.EXTREMITIES_ASSESSMENT__EXTREMITIES_ASSESSMENT_VALUE_P,
						 EmspcrPlugin.INSTANCE.getString("ExtremitiesAssessmentExtremitiesAssessmentValueP"),
						 new Object [] { extremitiesAssessment }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_EXTREMITIES_ASSESSMENT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.targetSiteCode->isEmpty() or self.targetSiteCode->exists(element | element.isNullFlavorUndefined())) implies (not self.targetSiteCode->isEmpty())";
	...
	public static  boolean validateExtremitiesAssessmentTargetSiteCodeP(ExtremitiesAssessment extremitiesAssessment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_EXTREMITIES_ASSESSMENT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(extremitiesAssessment)) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ExtremitiesAssessmentExtremitiesAssessmentTargetSiteCodeP"),
						 new Object [] { extremitiesAssessment }));
			}
			...
			if (context != null) {
				// generate a pass token for my dependent constraints to short-circuit or filter results
				@SuppressWarnings("unchecked")
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.emspcr.ExtremitiesAssessmentTargetSiteCodeP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.emspcr.ExtremitiesAssessmentTargetSiteCodeP", passToken);
				}
				passToken.add(extremitiesAssessment);
			}
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA18739-5' or value.code = 'LA18740-3' or value.code = 'LA18741-1' or value.code = 'LA18742-9' or value.code = 'LA18743-7' or value.code = 'LA18744-5' or value.code = 'LA18745-2' or value.code = 'LA18746-0' or value.code = 'LA18747-8' or value.code = 'LA18748-6' or value.code = 'LA18749-4' or value.code = 'LA18750-2' or value.code = 'LA18751-0' or value.code = 'LA18752-8' or value.code = 'LA18753-6' or value.code = 'LA18754-4' or value.code = 'LA18755-1' or value.code = 'LA18756-9' or value.code = 'LA18757-7' or value.code = 'LA18758-5' or value.code = 'LA18759-3' or value.code = 'LA18760-1' or value.code = 'LA18761-9' or value.code = 'LA18762-7' or value.code = 'LA18763-5' or value.code = 'LA18764-3' or value.code = 'LA18765-0' or value.code = 'LA18766-8' or value.code = 'LA18767-6' or value.code = 'LA18768-4' or value.code = 'LA18769-2' or value.code = 'LA18770-0' or value.code = 'LA18771-8' or value.code = 'LA18772-6' or value.code = 'LA18773-4' or value.code = 'LA18774-2' or value.code = 'LA18775-9' or value.code = 'LA18776-7' or value.code = 'LA18777-5' or value.code = 'LA18778-3' or value.code = 'LA18779-1' or value.code = 'LA18780-9' or value.code = 'LA18781-7' or value.code = 'LA18782-5' or value.code = 'LA18783-3' or value.code = 'LA18784-1' or value.code = 'LA18785-8' or value.code = 'LA18786-6')))";
	...
	public static  boolean validateExtremitiesAssessmentTargetSiteCode(ExtremitiesAssessment extremitiesAssessment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.emspcr.ExtremitiesAssessmentTargetSiteCodeP");
		if ((passToken instanceof Collection<?>) && ((Collection<?>) passToken).contains(extremitiesAssessment)) {
			// I have a free pass to short-circuit
			return true;
		}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ExtremitiesAssessmentExtremitiesAssessmentTargetSiteCode"),
						 new Object [] { extremitiesAssessment }));
			}
