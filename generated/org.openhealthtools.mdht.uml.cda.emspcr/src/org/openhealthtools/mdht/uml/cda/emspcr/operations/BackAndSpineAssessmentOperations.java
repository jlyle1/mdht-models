				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BackAndSpineAssessmentBackAndSpineAssessmentTemplateId"),
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BackAndSpineAssessmentBackAndSpineAssessmentMoodCode"),
						 new Object [] { backAndSpineAssessment }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BackAndSpineAssessmentBackAndSpineAssessmentCodeP"),
						 new Object [] { backAndSpineAssessment }));
			}
...
"value.code = '67532-2' and value.codeSystem = '2.16.840.1.113883.6.1')";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BackAndSpineAssessmentBackAndSpineAssessmentCode"),
						 new Object [] { backAndSpineAssessment }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BackAndSpineAssessmentBackAndSpineAssessmentEffectiveTime"),
						 new Object [] { backAndSpineAssessment }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_BACK_AND_SPINE_ASSESSMENT_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (self.value->forAll(element | not element.oclIsUndefined() and element.oclIsKindOf(datatypes::CD) and "+
"let value : datatypes::CD = element.oclAsType(datatypes::CD) in "+
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17208-2' or value.code = 'LA17209-0' or value.code = 'LA17214-0' or value.code = 'LA17212-4' or value.code = 'LA17256-1' or value.code = 'LA17257-9' or value.code = 'LA17258-7' or value.code = 'LA17259-5' or value.code = 'LA18220-6' or value.code = 'LA18221-4' or value.code = 'LA18222-2' or value.code = 'LA18223-0' or value.code = 'LA18224-8' or value.code = 'LA18225-5' or value.code = 'LA18226-3' or value.code = 'LA6626-1' or value.code = 'LA6630-3' or value.code = 'LA7410-9' or value.code = 'LA7452-1' or value.code = 'LA7460-4' or value.code = 'LA17709-9' or value.code = 'LA17229-8' or value.code = 'LA22440-4' or value.code = 'LA7423-2')))";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BackAndSpineAssessmentBackAndSpineAssessmentValue"),
						 new Object [] { backAndSpineAssessment }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_BACK_AND_SPINE_ASSESSMENT_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (self.value->forAll(element | element.oclIsTypeOf(datatypes::CD)))";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BackAndSpineAssessmentBackAndSpineAssessmentValueP"),
						 new Object [] { backAndSpineAssessment }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_BACK_AND_SPINE_ASSESSMENT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.targetSiteCode->isEmpty() or self.targetSiteCode->exists(element | element.isNullFlavorUndefined())) implies (not self.targetSiteCode->isEmpty())";
	...
	public static  boolean validateBackAndSpineAssessmentTargetSiteCodeP(BackAndSpineAssessment backAndSpineAssessment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_BACK_AND_SPINE_ASSESSMENT_TARGET_SITE_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(backAndSpineAssessment)) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BackAndSpineAssessmentBackAndSpineAssessmentTargetSiteCodeP"),
						 new Object [] { backAndSpineAssessment }));
			}
			...
			if (context != null) {
				// generate a pass token for my dependent constraints to short-circuit or filter results
				@SuppressWarnings("unchecked")
				Collection<Object> passToken = (Collection<Object>) context.get("org.openhealthtools.mdht.uml.cda.emspcr.BackAndSpineAssessmentTargetSiteCodeP");
				if (passToken == null) {
					// anticipate a reasonably healthy model
					passToken = new java.util.ArrayList<Object>(3);
					context.put("org.openhealthtools.mdht.uml.cda.emspcr.BackAndSpineAssessmentTargetSiteCodeP", passToken);
				}
				passToken.add(backAndSpineAssessment);
			}
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA18726-2' or value.code = 'LA18727-0' or value.code = 'LA18728-8' or value.code = 'LA18729-6' or value.code = 'LA18730-4' or value.code = 'LA18731-2' or value.code = 'LA18732-0' or value.code = 'LA18733-8' or value.code = 'LA18734-6' or value.code = 'LA18735-3' or value.code = 'LA18736-1' or value.code = 'LA18737-9' or value.code = 'LA18738-7')))";
	...
	public static  boolean validateBackAndSpineAssessmentTargetSiteCode(BackAndSpineAssessment backAndSpineAssessment, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		Object passToken = (context == null) ? null : context.get("org.openhealthtools.mdht.uml.cda.emspcr.BackAndSpineAssessmentTargetSiteCodeP");
		if ((passToken instanceof Collection<?>) && ((Collection<?>) passToken).contains(backAndSpineAssessment)) {
			// I have a free pass to short-circuit
			return true;
		}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("BackAndSpineAssessmentBackAndSpineAssessmentTargetSiteCode"),
						 new Object [] { backAndSpineAssessment }));
			}
