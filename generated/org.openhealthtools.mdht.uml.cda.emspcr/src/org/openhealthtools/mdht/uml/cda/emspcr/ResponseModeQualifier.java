 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='ResponseModeQualifierTemplateId ResponseModeQualifierClassCode ResponseModeQualifierCode ResponseModeQualifierCodeP ResponseModeQualifierMoodCode ResponseModeQualifierValue' templateId.root='2.16.840.1.1133883.17.3.10.1.191' classCode='OBS' code.code='77157-6' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='Response mode descriptors' constraints.validation.dependOn.ResponseModeQualifierCode='ResponseModeQualifierCodeP' moodCode='EVN'"
 * @generated
 */
public interface ResponseModeQualifier extends Observation {
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'2.16.840.1.1133883.17.3.10.1.191\')'"
	 * @generated
	 */
