				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportClassCode"),
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportMoodCode"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportCodeP"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportCode"),
						 new Object [] { patientCareReport }));
			}
...
"value.codeSystem = '2.16.840.1.113883.5.25' and (value.code = 'N' or value.code = 'R' or value.code = 'V'))";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportConfidentialityCode"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportRecordTarget"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportCurrentMedication"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportCardiacArrestEvent"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportAdvanceDirectives"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportAllergiesAndAdverseReactionsSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportPastMedicalHistorySection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportSocialHistorySection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportPhysicalAssessmentSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportMedicationsAdministeredSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportProceduresPerformedSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportPatientCareNarrativeSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportSceneSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportDispatchSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportDispositionSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportPersonnelAdverseEventSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportProtocolSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportResponseSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportSituationSection"),
						 new Object [] { patientCareReport }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_PATIENT_CARE_REPORT_TIMES_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.getAllSections()->one(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSTimesSection))";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportTimesSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportVitalSignsSection"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportAuthorParticipation"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportDocumentationOf"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportRelatedDocument"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportParticipant"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportInjuryIncidentDescriptionSection"),
						 new Object [] { patientCareReport }));
			}
	...
	public static  boolean validatePatientCareReportEMSBillingSection(PatientCareReport patientCareReport, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_PATIENT_CARE_REPORT_EMS_BILLING_SECTION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(patientCareReport)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportPatientCareReportEMSBillingSection"),
						 new Object [] { patientCareReport }));
			}
	 ...
	 * @ordered
	 */
	protected static final String GET_TIMES_SECTION__EOCL_EXP = "self.getAllSections()->select(section : cda::Section | not section.oclIsUndefined() and section.oclIsKindOf(emspcr::EMSTimesSection))->asSequence()->any(true).oclAsType(emspcr::EMSTimesSection)";
	...
	public static  EMSTimesSection getTimesSection(PatientCareReport patientCareReport) {
	...
	public static  EList<EMSBillingSection> getEMSBillingSections(PatientCareReport patientCareReport) {
		if (GET_EMS_BILLING_SECTIONS__EOCL_QRY == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setOperationContext(EmspcrPackage.Literals.PATIENT_CARE_REPORT, EmspcrPackage.Literals.PATIENT_CARE_REPORT.getEAllOperations().get(342));
			try {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportGeneralHeaderConstraintsTemplateId"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportGeneralHeaderConstraintsId"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportGeneralHeaderConstraintsTitle"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.INFO,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportGeneralHeaderConstraintsVersionNumber"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportGeneralHeaderConstraintsComponentOf"),
						 new Object [] { patientCareReport }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("PatientCareReportGeneralHeaderConstraintsCustodian"),
						 new Object [] { patientCareReport }));
			}
