...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Medication Complication Observation</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see org.openhealthtools.mdht.uml.cda.emspcr.EmspcrPackage#getMedicationComplicationObservation()
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='MedicationComplicationObservationTemplateId MedicationComplicationObservationMoodCode MedicationComplicationObservationCode MedicationComplicationObservationCodeP MedicationComplicationObservationValue MedicationComplicationObservationValueP' templateId.root='2.16.840.1.1133883.17.3.10.1.107' moodCode='EVN' code.code='67541-3' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='Medication complication NEMSIS' constraints.validation.dependOn.MedicationComplicationObservationCode='MedicationComplicationObservationCodeP' value.codeSystem='2.16.840.1.113883.6.1' value.codeSystemName='LOINC'"
 * @generated
 */
public interface MedicationComplicationObservation extends Observation {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model annotation="http://www.eclipse.org/uml2/1.1.0/GenModel body='self.templateId->exists(id : datatypes::II | id.root = \'2.16.840.1.1133883.17.3.10.1.107\')'"
	 * @generated
	 */
	boolean validateMedicationComplicationObservationTemplateId(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateMedicationComplicationObservationMoodCode(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateMedicationComplicationObservationCodeP(DiagnosticChain diagnostics, Map<Object, Object> context);
	 ...
	 * @generated
	 */
	boolean validateMedicationComplicationObservationValueP(DiagnosticChain diagnostics, Map<Object, Object> context);
