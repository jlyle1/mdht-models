...
public class CardiacArrestOutcomeOperations extends ClinicalStatementOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_CARDIAC_ARREST_OUTCOME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.templateId->exists(id : datatypes::II | id.root = '2.16.840.1.1133883.17.3.10.1.184')";
	...
	protected static Constraint VALIDATE_CARDIAC_ARREST_OUTCOME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateCardiacArrestOutcomeTemplateId(CardiacArrestOutcome cardiacArrestOutcome, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_CARDIAC_ARREST_OUTCOME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.CARDIAC_ARREST_OUTCOME);
			try {
				VALIDATE_CARDIAC_ARREST_OUTCOME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_CARDIAC_ARREST_OUTCOME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_OUTCOME_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestOutcome)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	protected static Constraint VALIDATE_CARDIAC_ARREST_OUTCOME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateCardiacArrestOutcomeCodeP(CardiacArrestOutcome cardiacArrestOutcome, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_CARDIAC_ARREST_OUTCOME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.CARDIAC_ARREST_OUTCOME);
			try {
				VALIDATE_CARDIAC_ARREST_OUTCOME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_CARDIAC_ARREST_OUTCOME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_OUTCOME_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestOutcome)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '77152-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	protected static Constraint VALIDATE_CARDIAC_ARREST_OUTCOME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateCardiacArrestOutcomeCode(CardiacArrestOutcome cardiacArrestOutcome, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (VALIDATE_CARDIAC_ARREST_OUTCOME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.CARDIAC_ARREST_OUTCOME);
			try {
				VALIDATE_CARDIAC_ARREST_OUTCOME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_CARDIAC_ARREST_OUTCOME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_OUTCOME_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestOutcome)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	protected static Constraint VALIDATE_CARDIAC_ARREST_OUTCOME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateCardiacArrestOutcomeMoodCode(CardiacArrestOutcome cardiacArrestOutcome, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_CARDIAC_ARREST_OUTCOME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.CARDIAC_ARREST_OUTCOME);
			try {
				VALIDATE_CARDIAC_ARREST_OUTCOME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_CARDIAC_ARREST_OUTCOME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_OUTCOME_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestOutcome)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA22792-8' or value.code = 'LA22793-6' or value.code = 'LA22794-4' or value.code = 'LA22795-1' or value.code = 'LA22796-9' or value.code = 'LA22797-7')))";
	...
	protected static Constraint VALIDATE_CARDIAC_ARREST_OUTCOME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV;
	...
	public static  boolean validateCardiacArrestOutcomeValue(CardiacArrestOutcome cardiacArrestOutcome, DiagnosticChain diagnostics, Map<Object, Object> context) {
  	  
		if (VALIDATE_CARDIAC_ARREST_OUTCOME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null) {
			OCL.Helper helper = EOCL_ENV.createOCLHelper();
			helper.setContext(EmspcrPackage.Literals.CARDIAC_ARREST_OUTCOME);
			try {
				VALIDATE_CARDIAC_ARREST_OUTCOME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper.createInvariant(VALIDATE_CARDIAC_ARREST_OUTCOME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		}
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_OUTCOME_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestOutcome)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
