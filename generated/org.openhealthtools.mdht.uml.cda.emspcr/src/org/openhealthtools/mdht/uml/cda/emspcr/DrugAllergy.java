 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.error='DrugAllergyParticipant1 DrugAllergyTemplateId DrugAllergyCode DrugAllergyValue1 DrugAllergyMoodCode' templateId.root='2.16.840.1.1133883.17.3.10.1.48' code.code='ASSERTION' code.codeSystem='2.16.840.1.113883.5.4' code.codeSystemName='ActCode' code.displayName='ASSERTION' value1.code='416098002' value1.codeSystem='2.16.840.1.113883.6.96' value1.codeSystemName='SNOMEDCT' value1.displayName='Drug allergy (disorder)' moodCode='EVN'"
...
public interface DrugAllergy extends Observation {
	 ...
	 * @generated
	 */
	boolean validateDrugAllergyValue1(DiagnosticChain diagnostics, Map<Object, Object> context);
