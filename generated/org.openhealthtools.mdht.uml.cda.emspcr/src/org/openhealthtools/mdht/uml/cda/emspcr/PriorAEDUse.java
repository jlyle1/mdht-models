 ...
 * @model annotation="http://www.openhealthtools.org/mdht/uml/cda/annotation constraints.validation.info='PriorAEDUsePriorAEDProviderParticipation' constraints.validation.error='PriorAEDUseTemplateId PriorAEDUseMoodCode PriorAEDUseCode PriorAEDUseValue' templateId.root='2.16.840.1.1133883.17.3.10.1.126' moodCode='EVN' code.code='67508-2' code.codeSystem='2.16.840.1.113883.6.1' code.codeSystemName='LOINC' code.displayName='AED use prior to EMS arrival NEMSIS' value.codeSystem='2.16.840.1.113883.6.1' value.codeSystemName='LOINC'"
