				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("IncidentDispositionObservationIncidentDispositionObservationTemplateId"),
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("IncidentDispositionObservationIncidentDispositionObservationMoodCode"),
						 new Object [] { incidentDispositionObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("IncidentDispositionObservationIncidentDispositionObservationCodeP"),
						 new Object [] { incidentDispositionObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("IncidentDispositionObservationIncidentDispositionObservationCode"),
						 new Object [] { incidentDispositionObservation }));
			}
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17154-8' or value.code = 'LA17155-5' or value.code = 'LA17156-3' or value.code = 'LA17159-7' or value.code = 'LA17160-5' or value.code = 'LA17161-3' or value.code = 'LA17162-1' or value.code = 'LA17163-9' or value.code = 'LA17164-7' or value.code = 'LA17165-4' or value.code = 'LA17166-2' or value.code = 'LA17167-0' or value.code = 'LA18080-4' or value.code = 'LA18212-3' or value.code = 'LA18213-1' or value.code = 'LA18214-9' or value.code = 'LA18215-6' or value.code = 'LA18216-4' or value.code = 'LOINC_TBDA_561' or value.code = 'LOINC_TBDA_562' or value.code = 'LOINC_TBDA_563' or value.code = 'LOINC_TBDA_564')))";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("IncidentDispositionObservationIncidentDispositionObservationValue"),
						 new Object [] { incidentDispositionObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("IncidentDispositionObservationIncidentDispositionObservationValueP"),
						 new Object [] { incidentDispositionObservation }));
			}
