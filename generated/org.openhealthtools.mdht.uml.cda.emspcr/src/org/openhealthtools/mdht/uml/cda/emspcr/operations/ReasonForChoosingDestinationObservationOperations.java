				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ReasonForChoosingDestinationObservationReasonForChoosingDestinationObservationTemplateId"),
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ReasonForChoosingDestinationObservationReasonForChoosingDestinationObservationMoodCode"),
						 new Object [] { reasonForChoosingDestinationObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ReasonForChoosingDestinationObservationReasonForChoosingDestinationObservationCodeP"),
						 new Object [] { reasonForChoosingDestinationObservation }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ReasonForChoosingDestinationObservationReasonForChoosingDestinationObservationCode"),
						 new Object [] { reasonForChoosingDestinationObservation }));
			}
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17059-9' or value.code = 'LA17182-9' or value.code = 'LA17184-5' or value.code = 'LA17185-2' or value.code = 'LA17186-0' or value.code = 'LA17187-8' or value.code = 'LA17188-6' or value.code = 'LA17189-4' or value.code = 'LA17190-2' or value.code = 'LA17191-0' or value.code = 'LA18301-4')))";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ReasonForChoosingDestinationObservationReasonForChoosingDestinationObservationValue"),
						 new Object [] { reasonForChoosingDestinationObservation }));
			}
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_REASON_FOR_CHOOSING_DESTINATION_OBSERVATION_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "(self.value->isEmpty() or self.value->exists(element | element.isNullFlavorUndefined())) implies (not self.value->isEmpty() and self.value->forAll(element | element.oclIsTypeOf(datatypes::CD)))";
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("ReasonForChoosingDestinationObservationReasonForChoosingDestinationObservationValueP"),
						 new Object [] { reasonForChoosingDestinationObservation }));
			}
