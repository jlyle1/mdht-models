...
public class ComplaintOrganSystemOperations extends ClinicalStatementOperations {
	...
	public static  boolean validateComplaintOrganSystemTemplateId(ComplaintOrganSystem complaintOrganSystem, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COMPLAINT_ORGAN_SYSTEM_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(complaintOrganSystem)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateComplaintOrganSystemMoodCode(ComplaintOrganSystem complaintOrganSystem, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COMPLAINT_ORGAN_SYSTEM_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(complaintOrganSystem)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateComplaintOrganSystemCodeP(ComplaintOrganSystem complaintOrganSystem, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COMPLAINT_ORGAN_SYSTEM_CODE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(complaintOrganSystem)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.code = '69468-7' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateComplaintOrganSystemCode(ComplaintOrganSystem complaintOrganSystem, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COMPLAINT_ORGAN_SYSTEM_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(complaintOrganSystem)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA16968-2' or value.code = 'LA18114-1' or value.code = 'LA18277-6' or value.code = 'LA18278-4' or value.code = 'LA18279-2' or value.code = 'LA18281-8' or value.code = 'LA18282-6' or value.code = 'LA18283-4' or value.code = 'LA18284-2' or value.code = 'LA18285-9' or value.code = 'LA9534-4')))";
	...
	public static  boolean validateComplaintOrganSystemValue(ComplaintOrganSystem complaintOrganSystem, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COMPLAINT_ORGAN_SYSTEM_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(complaintOrganSystem)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static  boolean validateComplaintOrganSystemValueP(ComplaintOrganSystem complaintOrganSystem, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_COMPLAINT_ORGAN_SYSTEM_VALUE_P__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(complaintOrganSystem)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
