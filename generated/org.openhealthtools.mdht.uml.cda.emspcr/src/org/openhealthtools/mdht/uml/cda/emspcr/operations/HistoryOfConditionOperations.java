				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HistoryOfConditionHistoryOfConditionTemplateId"),
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HistoryOfConditionHistoryOfConditionMoodCode"),
						 new Object [] { historyOfCondition }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HistoryOfConditionHistoryOfConditionCodeP"),
						 new Object [] { historyOfCondition }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HistoryOfConditionHistoryOfConditionCode"),
						 new Object [] { historyOfCondition }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HistoryOfConditionHistoryOfConditionValue"),
						 new Object [] { historyOfCondition }));
			}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("HistoryOfConditionHistoryOfConditionValueP"),
						 new Object [] { historyOfCondition }));
			}
