...
public class EmspcrFactoryImpl extends EFactoryImpl implements EmspcrFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case EmspcrPackage.PRIMARY_DESTINATION_HOSPITAL_CAPABILITY: return createPrimaryDestinationHospitalCapability();
			...
			case EmspcrPackage.UNIT_LEVEL_OF_CARE_CAPABILITY: return createUnitLevelOfCareCapability();
	 ...
	 * @generated
	 */
	public PrimaryDestinationHospitalCapability createPrimaryDestinationHospitalCapability() {
		PrimaryDestinationHospitalCapabilityImpl primaryDestinationHospitalCapability = new PrimaryDestinationHospitalCapabilityImpl();
		return primaryDestinationHospitalCapability;
	}
	 ...
	 * @generated
	 */
	public UnitLevelOfCareCapability createUnitLevelOfCareCapability() {
		UnitLevelOfCareCapabilityImpl unitLevelOfCareCapability = new UnitLevelOfCareCapabilityImpl();
		return unitLevelOfCareCapability;
	}
