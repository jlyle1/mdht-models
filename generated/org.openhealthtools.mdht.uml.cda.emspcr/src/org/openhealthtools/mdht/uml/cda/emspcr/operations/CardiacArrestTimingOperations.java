...
public class CardiacArrestTimingOperations extends ClinicalStatementOperations {
	...
	public static  boolean validateCardiacArrestTimingTemplateId(CardiacArrestTiming cardiacArrestTiming, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_TIMING_TEMPLATE_ID__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestTiming)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("CardiacArrestTimingCardiacArrestTimingTemplateId"),
	...
	public static  boolean validateCardiacArrestTimingMoodCode(CardiacArrestTiming cardiacArrestTiming, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_TIMING_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestTiming)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("CardiacArrestTimingCardiacArrestTimingMoodCode"),
						 new Object [] { cardiacArrestTiming }));
			}
...
"value.code = '67502-5' and value.codeSystem = '2.16.840.1.113883.6.1')";
	...
	public static  boolean validateCardiacArrestTimingCode(CardiacArrestTiming cardiacArrestTiming, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_TIMING_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestTiming)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("CardiacArrestTimingCardiacArrestTimingCode"),
						 new Object [] { cardiacArrestTiming }));
			}
...
"value.codeSystem = '2.16.840.1.113883.6.1' and (value.code = 'LA17054-0' or value.code = 'LA17055-7')))";
	...
	public static  boolean validateCardiacArrestTimingValue(CardiacArrestTiming cardiacArrestTiming, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (!EOCL_ENV.createQuery(VALIDATE_CARDIAC_ARREST_TIMING_VALUE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(cardiacArrestTiming)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 EmspcrPlugin.INSTANCE.getString("CardiacArrestTimingCardiacArrestTimingValue"),
						 new Object [] { cardiacArrestTiming }));
			}
